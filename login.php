...
or die("Failed to Connect Server" .mysqli_connect_error());
  ...
  ?>
   ...
   <!--SIGIN START-->
    <a id="uimg" class="btn btn-outline-success float-end position-relative me-5" data-bs-toggle="modal" data-bs-target="#exampleModal"><img  style="width:3rem" src="./image/user.jpg" alt="..."><br><?php echo $message1;?></a>
...
<!--login form-->
  ...
  <form class="px-4 py-3" action="logout.php" method="post">
    ...
    <div class="mb-3 col-md-4">
      <label class="mx-auto ms-5 text-center fs-3" style="color:white" for="exampleDropdownFormPassword1" class="form-label"><b><?php echo $message1;?></b></label>
    </div>
...
<!--SIGIN END-->
  ...
  <div class="container-fluid">
    ...
    <div class="shadow collapse navbar-collapse nv gap-3" id="navbarNav" style="background-color: #268454">
      <ul class="navbar-nav mx-5">
        ...
        <li class="nav-item py-2">
          <a class="nav-link" href="book.php?Get_email=<?php echo $message1;?>">Booking <i class="fa-solid fa-pen-clip"></i></a>
        </li>
        <li class="nav-item py-2">
  ...
  <div class="carousel-inner mx-auto"  style="width:90rem; height:40rem">
    <div class="carousel-item active">
      <img src="./image/blog-1.jpg" style="width:10rem" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item">
      <img src="./image/blog-2.jpg" style="width:10rem" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item">
      <img src="./image/blog-3.jpg" style="width:10rem" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
  </div>
...
<div class="card col-md-4 gap-2 mx-auto" style="width: 18rem;" id="dac1">
  ...
  <h3 class="card-title">Total Care</h3>
    ...
    <a class="btn btn-outline-warning ms-5" id="butn" data-bs-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample" onclick=" myfunction()">
         See More >
      </a> 
  </div>
</div>
